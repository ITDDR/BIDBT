select
    ...
    cid.content,
    cid.eye_side,
    -1 * pd.prix_achat_catalogue_ht as prix_achat_catalogue_ht,
    -1 * pd.prix_achat_magasin_ht as prix_achat_magasin_ht,
    -1 * credit_note_value_with_vat as prix_vente_remise_ttc,
